...
class AE_extreme(tf.keras.Model):

    def __init__(self, input_size, encoded_size, checkpoint_file = False, data_features = 100):
        super(AE_extreme, self).__init__()
        ...
        self.encoder = Sequential([
            ...
            Dense(ceil(input_size / 4), activation = 'relu'),
            Dense(ceil(input_size / 16), activation = 'relu'),
            Dense(ceil(input_size / 64), activation = 'relu'),
            Dense(ceil(input_size / 256), activation = 'relu'),
